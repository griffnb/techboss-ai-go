...
3. **Smart Retrieval**:  Avoid scanning lots of files, use `#code_tools docs` and `#kcb` tools to look at packages and functions in a much more efficient way, if it doesnt return what you need, then you can search using grep and globs
