//go:generate core_gen controller LifecycleTestPlaceholder -modelPackage=lifecycle_test_placeholder -options=admin
...
const (
	TABLE_NAME string = lifecycle_test_placeholder.TABLE
	ROUTE      string = "lifecycle_test_placeholder"
)
