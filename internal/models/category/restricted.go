...
func FindAllRestrictedJoined(ctx context.Context, options *model.Options, _ coremodel.Model) ([]*CategoryJoined, error) {
...
func FindAllRestricted(ctx context.Context, options *model.Options, _ coremodel.Model) ([]*Category, error) {
	// Uncomment and adjust the following lines to implement proper restrictions
	// options.WithCondition("%s = :account_id:", Columns.AccountID.Column())
	// options.WithParam(":account_id:", sessionAccount.ID())
...
func GetRestrictedJoined(ctx context.Context, id types.UUID, _ coremodel.Model) (*CategoryJoined, error) {
...
func GetRestricted(ctx context.Context, id types.UUID, _ coremodel.Model) (*Category, error) {
	options := model.NewOptions().
		WithCondition("%s.id = :id:", TABLE).
		WithParam(":id:", id)
		// TODO: Add appropriate restrictions for categories if needed
