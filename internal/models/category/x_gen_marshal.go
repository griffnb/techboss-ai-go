...
func (this *Category) UnmarshalJSON(data []byte) error {
...
func (this *Category) UnmarshalDynamoDBAttributeValue(av aws_types.AttributeValue) error {
	this.InitializeWithChangeLogs(&model.InitializeOptions{
		Table:       TABLE,
		Model:       MODEL,
		ChangeLogs:  CHANGE_LOGS,
...
func (r *Category) Scan(src any) error {
	switch v := src.(type) {
	case nil:
		*r = Category{}
		return nil
	...
	default:
		return errors.Errorf("Category.Scan: unsupported type %T", src)
	}
}

func (r *Category) Value() (driver.Value, error) {
