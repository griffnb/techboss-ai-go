...
func (this *GithubInstallation) UnmarshalJSON(data []byte) error {
...
func (this *GithubInstallation) UnmarshalDynamoDBAttributeValue(av aws_types.AttributeValue) error {
	this.InitializeWithChangeLogs(&model.InitializeOptions{
		Table:       TABLE,
		Model:       MODEL,
		ChangeLogs:  CHANGE_LOGS,
...
func (r *GithubInstallation) Scan(src any) error {
	switch v := src.(type) {
	case nil:
		*r = GithubInstallation{}
		return nil
	case []byte:
	...
	default:
		return errors.Errorf("GithubInstallation.Scan: unsupported type %T", src)
	}
}

func (r *GithubInstallation) Value() (driver.Value, error) {
