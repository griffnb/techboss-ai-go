...
var Columns *GithubInstallation

const (
	PACKAGE string = "github_installation"
...
func New() *GithubInstallation {
	return NewType[*GithubInstallation]()
}
...
func (this *GithubInstallation) Save(savingUser coremodel.Model) error {
	return this.SaveWithContext(context.Background(), savingUser)
}

func (this *GithubInstallation) SaveWithContext(ctx context.Context, savingUser coremodel.Model) error {
