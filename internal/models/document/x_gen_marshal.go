...
func (this *Document) UnmarshalJSON(data []byte) error {
...
func (this *Document) UnmarshalDynamoDBAttributeValue(av aws_types.AttributeValue) error {
	this.InitializeWithChangeLogs(&model.InitializeOptions{
		Table:       TABLE,
		Model:       MODEL,
		ChangeLogs:  CHANGE_LOGS,
...
func (r *Document) Scan(src any) error {
	switch v := src.(type) {
	case nil:
		*r = Document{}
		return nil
	...
	default:
		return errors.Errorf("Document.Scan: unsupported type %T", src)
	}
}

func (r *Document) Value() (driver.Value, error) {
