...
func (this *Document) Save(savingUser coremodel.Model) error {
	return this.SaveWithContext(context.Background(), savingUser)
}

func (this *Document) SaveWithContext(ctx context.Context, savingUser coremodel.Model) error {
