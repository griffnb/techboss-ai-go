...
var Columns *Subscription

const (
	PACKAGE string = "subscription"
	MODEL   string = "Subscription"
)
...
func (this *Subscription) Save(savingUser coremodel.Model) error {
	return this.SaveWithContext(context.Background(), savingUser)
}

func (this *Subscription) SaveWithContext(ctx context.Context, savingUser coremodel.Model) error {
