...
var Columns *LifecycleTestPlaceholder

const (
	PACKAGE string = "lifecycle_test_placeholder"
	MODEL   string = "LifecycleTestPlaceholder"
)
...
func New() *LifecycleTestPlaceholder {
	return NewType[*LifecycleTestPlaceholder]()
}
...
func (this *LifecycleTestPlaceholder) Save(savingUser coremodel.Model) error {
	return this.SaveWithContext(context.Background(), savingUser)
}

func (this *LifecycleTestPlaceholder) SaveWithContext(ctx context.Context, savingUser coremodel.Model) error {
