...
func (this *ObjectTag) UnmarshalJSON(data []byte) error {
...
func (this *ObjectTag) UnmarshalDynamoDBAttributeValue(av aws_types.AttributeValue) error {
	this.InitializeWithChangeLogs(&model.InitializeOptions{
		Table:       TABLE,
		Model:       MODEL,
		ChangeLogs:  CHANGE_LOGS,
...
func (r *ObjectTag) Scan(src any) error {
	switch v := src.(type) {
	case nil:
		*r = ObjectTag{}
		return nil
	...
	default:
		return errors.Errorf("ObjectTag.Scan: unsupported type %T", src)
	}
}

func (r *ObjectTag) Value() (driver.Value, error) {
