...
const (
	PACKAGE string = "sandbox"
	MODEL   string = "Sandbox"
)
...
func (this *Sandbox) Save(savingUser coremodel.Model) error {
	return this.SaveWithContext(context.Background(), savingUser)
}

func (this *Sandbox) SaveWithContext(ctx context.Context, savingUser coremodel.Model) error {
