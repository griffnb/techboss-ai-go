...
func (this *Tag) UnmarshalDynamoDBAttributeValue(av aws_types.AttributeValue) error {
	this.InitializeWithChangeLogs(&model.InitializeOptions{
		Table:       TABLE,
		Model:       MODEL,
		ChangeLogs:  CHANGE_LOGS,
...
func (r *Tag) Scan(src any) error {
	...
	default:
		return errors.Errorf("Tag.Scan: unsupported type %T", src)
	}
}

func (r *Tag) Value() (driver.Value, error) {
