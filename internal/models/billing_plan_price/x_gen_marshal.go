...
func (this *BillingPlanPrice) UnmarshalJSON(data []byte) error {
...
func (this *BillingPlanPrice) UnmarshalDynamoDBAttributeValue(av aws_types.AttributeValue) error {
	this.InitializeWithChangeLogs(&model.InitializeOptions{
		Table:       TABLE,
		Model:       MODEL,
		ChangeLogs:  CHANGE_LOGS,
...
func (r *BillingPlanPrice) Scan(src any) error {
	switch v := src.(type) {
	case nil:
		*r = BillingPlanPrice{}
		return nil
	...
	default:
		return errors.Errorf("BillingPlanPrice.Scan: unsupported type %T", src)
	}
}

func (r *BillingPlanPrice) Value() (driver.Value, error) {
