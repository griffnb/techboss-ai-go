...
func FindAll(ctx context.Context, options *model.Options) ([]*Admin, error) {
	return all[*Admin](ctx, options)
}

func FindFirst(ctx context.Context, options *model.Options) (*Admin, error) {
	return first[*Admin](ctx, options)
}

func Get(ctx context.Context, id types.UUID) (*Admin, error) {
	return get[*Admin](ctx, id)
}
...
func FindFirstJoined(ctx context.Context, options *model.Options) (*AdminJoined, error) {
	AddJoinData(options)
	return first[*AdminJoined](ctx, options)
}

// FindAllJoined Finds all records
func FindAllJoined(ctx context.Context, options *model.Options) ([]*AdminJoined, error) {
	AddJoinData(options)
	return all[*AdminJoined](ctx, options)
}
