...
func (this *Conversation) UnmarshalJSON(data []byte) error {
...
func (this *Conversation) UnmarshalDynamoDBAttributeValue(av aws_types.AttributeValue) error {
	this.InitializeWithChangeLogs(&model.InitializeOptions{
		Table:       TABLE,
		Model:       MODEL,
		ChangeLogs:  CHANGE_LOGS,
...
func (r *Conversation) Scan(src any) error {
	switch v := src.(type) {
	case nil:
		*r = Conversation{}
		return nil
	...
	default:
		return errors.Errorf("Conversation.Scan: unsupported type %T", src)
	}
}

func (r *Conversation) Value() (driver.Value, error) {
