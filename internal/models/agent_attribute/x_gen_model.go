...
var Columns *AgentAttribute

const (
	PACKAGE string = "agent_attribute"
	MODEL   string = "AgentAttribute"
)
...
func New() *AgentAttribute {
	return NewType[*AgentAttribute]()
}
...
func (this *AgentAttribute) Save(savingUser coremodel.Model) error {
	return this.SaveWithContext(context.Background(), savingUser)
}

func (this *AgentAttribute) SaveWithContext(ctx context.Context, savingUser coremodel.Model) error {
