...
func (this *AgentAttribute) UnmarshalJSON(data []byte) error {
...
func (this *AgentAttribute) UnmarshalDynamoDBAttributeValue(av aws_types.AttributeValue) error {
	this.InitializeWithChangeLogs(&model.InitializeOptions{
		Table:       TABLE,
		Model:       MODEL,
		ChangeLogs:  CHANGE_LOGS,
...
func (r *AgentAttribute) Scan(src any) error {
	switch v := src.(type) {
	case nil:
		*r = AgentAttribute{}
		return nil
	...
	default:
		return errors.Errorf("AgentAttribute.Scan: unsupported type %T", src)
	}
}

func (r *AgentAttribute) Value() (driver.Value, error) {
