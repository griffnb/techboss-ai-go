...
func (this *AiTool) Save(savingUser coremodel.Model) error {
	return this.SaveWithContext(context.Background(), savingUser)
}

func (this *AiTool) SaveWithContext(ctx context.Context, savingUser coremodel.Model) error {
