...
func (this *AiTool) UnmarshalJSON(data []byte) error {
...
func (this *AiTool) UnmarshalDynamoDBAttributeValue(av aws_types.AttributeValue) error {
	this.InitializeWithChangeLogs(&model.InitializeOptions{
		Table:       TABLE,
		Model:       MODEL,
		ChangeLogs:  CHANGE_LOGS,
...
func (r *AiTool) Scan(src any) error {
	switch v := src.(type) {
	case nil:
		*r = AiTool{}
		return nil
	...
	default:
		return errors.Errorf("AiTool.Scan: unsupported type %T", src)
	}
}

func (r *AiTool) Value() (driver.Value, error) {
