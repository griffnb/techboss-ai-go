...
func (this *Agent) Save(savingUser coremodel.Model) error {
	return this.SaveWithContext(context.Background(), savingUser)
}

func (this *Agent) SaveWithContext(ctx context.Context, savingUser coremodel.Model) error {
