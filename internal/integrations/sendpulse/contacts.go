...
// TODO https://sendpulse.com/integrations/api/crm#/Contacts/post_contacts_create
func (this *APIClient) CreateContact(ctx context.Context, todo any) (any, error) {
	token, err := this.GetToken()
	if err != nil {
		return nil, err
	}
...
// TODO https://sendpulse.com/integrations/api/crm#/Contacts/put_contacts__contactId_
func (this *APIClient) UpdateContact(ctx context.Context, id int64, todo any) (any, error) {
	token, err := this.GetToken()
	if err != nil {
		return nil, err
	}
...
// TODO https://sendpulse.com/integrations/api/crm#/Contacts/get_contacts__contactId_
func (this *APIClient) GetContact(ctx context.Context, id int64) (any, error) {
	token, err := this.GetToken()
	if err != nil {
		return nil, err
	}
...
// TODO https://sendpulse.com/integrations/api/crm#/Contacts/delete_contacts__contactId_
